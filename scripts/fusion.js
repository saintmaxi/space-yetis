...
const fuse = async() => {
    ...
    else if (await getPlasmaBalance() < 650) {
...
const getCyborgImages = async()=>{
    ...
    if (yourCyborgsCount == 0) {
        ...
        for (let i = 0; i < yourCyborgs.length; i++) {
            ...
            let fakeJSX = `<div id="cyborg-${cyborgId}" class="your-cyborg"><img src="${baseCyborgImageURI}${cyborgId}.png"><p class="cyborgid">#${cyborgId}</p></div>`
